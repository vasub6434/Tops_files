...
%>
			...
			<h3>Add Product</h3>
	<form  name="Insert" method="post" action="ProductController" enctype="multipart/form-data">
	...
	%>
		...
		<tr>
			<td>Product Name</td>
			<td><input type="text" value="<%=p.getProduct_name() %>" name="product_name"></td>
		</tr>
		<tr>
			<td>Product Price</td>
			<td><input type="text" value="<%=p.getProduct_price() %>" name="product_price"></td>
		</tr>
		
		<tr>
			<td>Images</td>
			<td><img src="product_picture/<%=p.getProduct_image() %>" style="width :100px;height :100px;"></td>
		</tr>
		<tr>
			<td>Product Discription</td>
			<td><textarea rows="5" cols="21" value="<%=p.getProduct_desc() %>" name="product_desc"></textarea></td>
		</tr>
