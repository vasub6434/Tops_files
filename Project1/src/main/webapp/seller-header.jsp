				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="seller-index.jsp">Home</a></li>
							<li class="nav-item active"><a class="nav-link" href="seller-addproduct.jsp">Add Product</a></li>
							<li class="nav-item active"><a class="nav-link" href="seller-viewproduct.jsp">View Product</a></li>
